        ...
        */ 
        ...
        if (collision.tag == "Portal_L")
        {
            if (collision.transform.name == "Portal_L")
            {
                ...
                camAni.Play("Left");
                move = false;
                player.transform.position = new Vector3(-12.42f, 0, 0); // 수정 완료
            }
            ...
            if (collision.transform.name == "Portal_L_2")
            {
                ...
                camAni.Play("Left_2");
                move = false;
                player.transform.position = new Vector3(6.9f, 0, 0); // 수정 완료
            }            
        }
        ...
        if (collision.tag == "Portal_R")
        {
            if (collision.transform.name == "Portal_R_2")
            {
                ...
                camAni.Play("Right_2");
                move = false;
                player.transform.position = new Vector3(-6.8f, 0, 0); // 수정 완료
            }
            ...
            if (collision.transform.name == "Portal_R")
            {
                ...
                camAni.Play("Right");
                move = false;
                player.transform.position = new Vector3(12.5f, 0, 0); // 수정 완료
            }
        ...
        if (collision.tag == "Portal_U")
        {
            if (collision.transform.name == "Portal_U_2") // 아래에서 중앙
            {
                ...
                camAni.Play("Up_2");
                move = false;
                player.transform.position = new Vector3(0, -2.5f, 0); // 수정 완료
            }
            ...
            if (collision.transform.name == "Portal_U") // 중앙에서 위
            {
                ...
                camAni.Play("Up");
                move = false;
                player.transform.position = new Vector3(0, 8.9f, 0); // 수정 완료
            }
        ...
        if (collision.tag == "Portal_D")
        {
            ...
            if (collision.transform.name == "Portal_D_2")
            {
                ...
                camAni.Play("Down_2");
                move = false;   
                player.transform.position = new Vector3(0, 2.6f, 0); // 수정 완료
            }
        }
    }
